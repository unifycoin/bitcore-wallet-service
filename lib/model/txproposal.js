...
TxProposal.prototype._buildTx = function () {
  ...
  if (self.fee < Defaults.MIN_TX_FEE) {
    self.fee = Defaults.MIN_TX_FEE;
  }
  t.fee(self.fee);

  t.settime(self.createdOn);
...
* by hms4
*/
TxProposal.prototype.getRawTxEx4 = function () {
  var t = this.getBitcoreTx();

  return t.uncheckedSerializeEx4();
};
